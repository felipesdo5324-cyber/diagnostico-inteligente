...
import {
  ...
  Wrench, Zap, Layers, Send, AlertCircle
} from 'lucide-react';
...
export default function DiagnosticPage() {
  ...
  const [resolutionType, setResolutionType] = useState<
    'salvar_depois' | 'conforme_manual' | 'forma_diferente'
  >('conforme_manual');
          ...
          <div className="animate-in slide-in-from-bottom-4 duration-500 space-y-8 pb-24">
            <Card className="border-l-[12px] border-l-green-600 shadow-xl relative overflow-visible">
              ...
              <div className="p-6 space-y-8 pl-10">
                ...
                <div>
                  <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 flex items-center gap-2">
                    <Wrench className="w-3 h-3" /> Plano de Ação
                  </h4>
            ...
            <Card className="bg-slate-900 border-none shadow-2xl overflow-hidden">
              <CardHeader className="border-b border-slate-800 bg-slate-800/50">
                <div className="flex items-center gap-2 text-white font-black uppercase tracking-widest text-xs">
                  <Send className="w-5 h-5 text-indigo-400" /> Registrar Solução no Banco de Dados
                </div>
              </CardHeader>
